...
<@layout.emailLayout>
    <tr>
        <td style="padding: 10px; border-bottom: 1px solid #32006e; background: linear-gradient(135deg, rgba(44, 216, 219, 0.51) 0%, rgba(153, 89, 249, 0.36) 48%, rgba(71, 159, 161, 0.45) 100%); border-radius: 5px 5px 0px 0px; display: flex; align-items: center;">
        ...
        <tr>
            <td style="padding: 20px; font-size: 15px; line-height: 1.5; color: #444;">
                ...
                <p style="text-align: left; margin: 30px 0px;">
                    <a href="${link}" style="background-color: #32006e; color: #ffffff; padding: 12px 25px; text-decoration: none; border-radius: 5px; display: inline-block; font-size: 16px;">${kcSanitize(msg("verifyEmail_button"))?no_esc}</a>
                </p>
    ...
    <#elseif requiredActions?seq_contains("UPDATE_PASSWORD")>
        <tr>
            <td style="padding: 20px; font-size: 15px; line-height: 1.5; color: #444;">
                <p style="font-size: 22px; font-weight: 700; color: #32006e; padding-bottom: 10px;">${kcSanitize(msg("passwordReset_titleMsg"))?no_esc}</p>
                <p>${kcSanitize(msg("greetingMsg"))?no_esc} ${user.firstName},</p>
                <p>${kcSanitize(msg("passwordReset_welcomeMsg"))?no_esc}</p>
                <p style="text-align: left; margin: 30px 0px;">
                    <a href="${link}" style="background-color: #32006e; color: #ffffff; padding: 12px 25px; text-decoration: none; border-radius: 5px; display: inline-block; font-size: 16px;">${kcSanitize(msg("passwordReset_button"))?no_esc}</a>
                </p>
